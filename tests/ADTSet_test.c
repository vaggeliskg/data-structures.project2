...
void new_test_create(void) {
	...
	TEST_ASSERT(set != NULL);
	TEST_ASSERT(set_size(set) == 11);

	set_destroy(set);
}

void new_test_insert(void) {
...
TEST_LIST = {
	...
	{ "set_create_from_sorted_values", new_test_create},
	{ "new_set_insert", new_test_insert },
	{ "new_set_remove", new_test_remove },
	{ "new_set_find", new_test_find },
	{ "new_set_iterate", new_test_iterate },
	{ "new_set_node_value",	new_test_node_value },
